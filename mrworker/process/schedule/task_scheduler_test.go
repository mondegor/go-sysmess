...
import (
	...
	"github.com/mondegor/go-sysmess/mrworker/process/schedule/mock"
)

//go:generate mockgen -destination=./mock/mrworker.go -package=mock github.com/mondegor/go-sysmess/mrworker Task
