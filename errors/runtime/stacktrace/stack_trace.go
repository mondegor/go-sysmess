...
// Iterator - возвращает функцию-итератор для последовательного чтения кадров стека.
// Каждый вызов возвращает: index, name (имя функции), file (путь к файлу), line (номер строки).
// Когда стек полностью прочитан, возвращает index = -1.
