...
// или time.RFC3339 и ошибку при нераспознанном значении.
//
// ВАЖНО: функция является хелпером логгера. Это не утилита общего
// назначения: для прикладного кода её использовать не следует.
